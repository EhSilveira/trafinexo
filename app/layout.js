...
export default function RootLayout({ children }) { return <html lang="pt-BR"><body><InfotecSplash/><ProductNavigation/>{children}<div className="internal-utility-footer"><BillingQuickLink/><PwaInstall/></div><script defer src="/factory-device.js" data-product="trafinexo" /></body></html>; }
