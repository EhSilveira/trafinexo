...
const commercialLower=commercial.toLowerCase();
if(!commercialLower.includes('performance intelligence')||!commercialLower.includes('profit roas')||!commercialLower.includes('tracking guardian')) throw new Error('Página comercial não apresenta os novos diferenciais');
